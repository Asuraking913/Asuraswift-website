...
function Steps() {
  return (
    <section className=' flex flex-col p-[5.5rem] pt-[2em] gap-[2em] items-center justify-center'>
          <h2 className='capitalize text-center pb-[1em] text-blue-600 font-[poppins] font-bold text-3xl'>Steps to use AsuraSwift Application</h2>
		  <ul className='flex flex-col gap-[1em] list-disc'>
			  ...
			  <div className='h-full w-full flex items-center justify-between px-[4em] py-[2em]'><img src={myImage} className='w-[350px] h-[200px]' alt="" /><i className='fa-solid fa-arrow-right text-4xl text-blue-600'></i>
			  <img src={myImage1} className='w-[350px] h-[200px]' alt="" /></div>
			  ...
			  <div className='h-full w-full flex items-center justify-between px-[4em] py-[2em]'><img src={myImage} className='w-[350px] h-[200px]' alt="" /><i className='fa-solid fa-arrow-right text-4xl text-blue-600'></i>
			  <img src={myImage2} className='w-[350px] h-[200px]' alt="" /></div>
