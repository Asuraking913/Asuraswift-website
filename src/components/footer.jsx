...
function Foot() {
  return (
    <section className='border-t-2 border-blue-600 bg-white p-[2em] pt-[2em] flex flex-col justify-between items-center gap-[4em]'>
        <ul className='flex items-center justify-center gap-[4em]'>
                {/* <li><a href="">Home</a></li> */}
                <Link to={"/descrip"}>
            ...
            <a href="#" className='absolute right-[2em]'><i className='fa-solid fa-arrow-up text-2xl hover:text-blue-600 hover:bg-[white] duration-[0.5s]  shadow-md hover:shadow-blue-600 animate-bounce bg-blue-600 text-white w-[50px] flex items-center justify-center rounded-[50%] h-[50px]'></i></a>
    </section>
  )
}
