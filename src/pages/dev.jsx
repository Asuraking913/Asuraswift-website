    ...
    <div>
      ...
      <section className=' flex p-[3em] gap-[3em] justify-center flex-col'>
        ...
        <ul className='flex items-center justify-between'>
          <li className='flex flex-col w-[32%] gap-[1em] text-center justify-center'>
            <a href="https://restaurant-website-one-sigma.vercel.app/" className='hover:scale-110 duration-[0.5s]'><img src={myImage} className='w-[400px] object-cover boxSha  h-[200px]' alt="" /></a>
          ...
          <li className='flex flex-col w-[32%] gap-[1em] text-center justify-center'>
          <a href="https://github.com/Asuraking913/AsuraSwift2.0" className='hover:scale-110 duration-[0.5s]'><img src={myImage2} className='w-[400px] object-cover  boxSha h-[200px]' alt="" /></a>
          ...
          <li className='flex flex-col w-[32%] gap-[1em] text-center justify-center'>
          <a href="https://banking-site-landing-page913.vercel.app/" className='hover:scale-110 duration-[0.5s]'><img src={myImage3} className='w-[400px] object-cover  boxSha h-[200px]' alt="" /></a>
            <h3 className='text-2xl popppins'>Bank Site</h3>
            <p className='roboto italic text-[1.2rem]'>A landing page for a banking site with no responsiveness</p>
          </li>
        </ul>
      </section>
      <Foot />
